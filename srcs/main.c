...
/*   Updated: 2023/04/25 08:29:20 by jonascim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// hitlst_add(hit_lst, (void *)sphere, OBJ_SPHERE);
	cylinder = init_cylinder((t_vector){0, -0.5, -1}, (t_vector){0, 1, 0}, 1, 0.3);
	hitlst_add(hit_lst, (void *)cylinder, OBJ_CYLINDER);
	plane = init_plane((t_vector){0, 1, 0}, (t_vector){0, -0.5, -1});
